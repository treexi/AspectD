...
--no-color run --machine --track-widget-creation --device-id=10ADBY275B0025Q --start-paused --release --verbose --dart-define=flutter.inspector.structuredErrors=true --devtools-server-address=http://127.0.0.1:9105 lib/main.dart
加个 --verbose
```
