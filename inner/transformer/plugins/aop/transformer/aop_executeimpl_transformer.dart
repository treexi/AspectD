...
//          && procedure.function.typeParameters.isEmpty
            ...
            for (Member filteredMember in filteredMembers) {
              if (filteredMember is Constructor) {
                ...
                transformMethodProcedure(
                    filteredLibrary, filteredMember as Procedure, aopItemInfo);
              }
            }
          }
        }
  ...
  void transformConstructor(Library originalLibrary, Constructor constructor,
    ...
    final Member originalStubConstructor = AopUtils.createStubConstructor(
        Name(constructorName + '_' + stubKey, constructor.parent!.parent as Library),
        aopItemInfo,
        constructor,
        body,
        shouldReturn);
    final Node parent = constructor.parent as Node;
    if (parent is Class) {
      parent.constructors.add(originalStubConstructor as Constructor);
      (originalStubConstructor as Constructor).parent = parent;
    }
